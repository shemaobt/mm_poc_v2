...
- **Backend** (`backend/`): See [backend/AGENTS.md](backend/AGENTS.md) for stack (FastAPI, Prisma, Pydantic), structure (api / services / core / models), and backend conventions.
- **Frontend** (`frontend/`): See [frontend/AGENTS.md](frontend/AGENTS.md) for stack (React, TypeScript, Tailwind, Zustand, Vite), component structure, styling (Tailwind only, no inline styles), and state management.

---

*This file is the single source of global guidelines for LLM agents in the mm_poc_v2 repository.*
